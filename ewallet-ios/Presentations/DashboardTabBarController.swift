...
class DashboardTabBarController: UITabBarController, UITabBarControllerDelegate {
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        let homeIc = UITabBarItem(title: "Home", image: UIImage(named: "ic-home.png"), selectedImage: UIImage(named: "ic-home.png"))
        home.tabBarItem = homeIc
        
        let wallet = BaseNavigationController(rootViewController: WalletViewController())
        let walletIc = UITabBarItem(title: "Wallet", image: UIImage(named: "ic-wallet.png"), selectedImage: UIImage(named: "ic-wallet.png"))
        wallet.tabBarItem = walletIc
        
        let statistics = BaseNavigationController(rootViewController: StatisticsViewController())
        let statisticsIc = UITabBarItem(title: "Statistics", image: UIImage(named: "ic-statistics.png"), selectedImage: UIImage(named: "ic-statistics.png"))
        statistics.tabBarItem = statisticsIc
        
        let voucher = BaseNavigationController(rootViewController: VoucherViewController())
        let voucherIc = UITabBarItem(title: "Voucher", image: UIImage(named: "ic-voucher.png"), selectedImage: UIImage(named: "ic-voucher.png"))
